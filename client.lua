local coords = {
    ...
    { x = 1124.277709961, y = 248.00709533692, z = -49.154418945312, h = 21.16987991333, model = GetHashKey("s_f_y_stripper_01"), anim = "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", lib = nil},
    ...
    { x = 1129.978149414, y = 242.18737792968, z = -49.438995361328, h = 207.87503051758, model = GetHashKey("s_f_y_stripper_01"), anim = "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", lib = nil},
    ...
    { x = 1129.5539550782, y = 256.68243408204, z = -51.040798187256, h = 346.48342895508, model = GetHashKey("s_f_y_hooker_01"), anim = 
    "owner_idle", lib = "anim@heists@fleeca_bank@ig_7_jetski_owner"},
